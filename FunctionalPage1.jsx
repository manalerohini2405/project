...
function FunctionalPage1() {
  ...
  const onSubmit = async (e) => {
    e.preventDefault();
    let waste = "";
    let url = `http://localhost:4000/addUserReq?name=${data.name}&state=${
      data.States
  ...
  return (
    <>
      ...
      <div className="FunctionalPage0Container">
        ...
        <div className="FunctionalPage2Containe">
          <div class="card text-bg-warning mb-3" style={{ maxWidth: "18rem" }}>
            <div class="card-header">Type of wastes</div>
            <div class="card-body">
              <h5 class="card-title">Biodegrade Waste</h5>
              <p class="card-text">
                material that can be decomposed easily by bacteria .
              </p>
            </div>
          </div>
          <div class="card text-bg-info mb-3" style={{ maxWidth: "18rem" }}>
            <div class="card-header">Type of wastes</div>
            <div class="card-body">
              <h5 class="card-title">Non Biodegrade Waste</h5>
              <p class="card-text">
                Waste that cannot be decomposed by the biological process.
              </p>
            </div>
          </div>
          <div class="card text-bg-light mb-3" style={{ maxWidth: "18rem" }}>
            <div class="card-header">Type of wastes</div>
            <div class="card-body">
              <h5 class="card-title">Dry and Biodegrade Waste</h5>
              <p class="card-text">
                Dry waste is a type of waste material that does not decompose .
              </p>
            </div>
          </div>
        </div>
